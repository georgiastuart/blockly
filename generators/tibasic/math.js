...
Blockly.TIBasic['math_arithmetic'] = function(block) {
  ...
  var OPERATORS = {
    'ADD': [' + ', Blockly.TIBasic.ORDER_ADDITION],
    'MINUS': [' - ', Blockly.TIBasic.ORDER_SUBTRACTION],
    'MULTIPLY': [' * ', Blockly.TIBasic.ORDER_MULTIPLICATION],
    'DIVIDE': [' / ', Blockly.TIBasic.ORDER_DIVISION],
    'POWER': [null, Blockly.TIBasic.ORDER_COMMA]  // Handle power separately.
  };
...
Blockly.TIBasic['math_single'] = function(block) {
  ...
  if (operator == 'SIN' || operator == 'COS' || operator == 'TAN') {
    arg = Blockly.TIBasic.valueToCode(block, 'NUM',
        Blockly.TIBasic.ORDER_DIVISION) || '0';
  } else {
    arg = Blockly.TIBasic.valueToCode(block, 'NUM',
  ...
  return [code, Blockly.TIBasic.ORDER_DIVISION];
};

Blockly.TIBasic['math_constant'] = function(block) {
  // Constants: PI, E, the Golden Ratio, sqrt(2), 1/sqrt(2), INFINITY.
  var CONSTANTS = {
    'PI': ['Math.PI', Blockly.TIBasic.ORDER_MEMBER],
    'E': ['Math.E', Blockly.TIBasic.ORDER_MEMBER],
    'GOLDEN_RATIO':
        ['(1 + Math.sqrt(5)) / 2', Blockly.TIBasic.ORDER_DIVISION],
    'SQRT2': ['Math.SQRT2', Blockly.TIBasic.ORDER_MEMBER],
    'SQRT1_2': ['Math.SQRT1_2', Blockly.TIBasic.ORDER_MEMBER],
...
Blockly.TIBasic['math_modulo'] = function(block) {
  ...
  return [code, Blockly.TIBasic.ORDER_MODULUS];
};
...
Blockly.TIBasic['math_random_float'] = function(block) {
  ...
  return ['Math.random()', Blockly.TIBasic.ORDER_FUNCTION_CALL];
};
