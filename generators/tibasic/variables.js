...
goog.provide('Blockly.TIBasic.variables');

goog.require('Blockly.TIBasic');


Blockly.TIBasic['variables_get'] = function(block) {
  // Variable getter.
  var code = Blockly.TIBasic.variableDB_.getName(block.getFieldValue('VAR'),
      Blockly.Variables.NAME_TYPE);
  return [code, Blockly.TIBasic.ORDER_ATOMIC];
};

Blockly.TIBasic['variables_set'] = function(block) {
  // Variable setter.
